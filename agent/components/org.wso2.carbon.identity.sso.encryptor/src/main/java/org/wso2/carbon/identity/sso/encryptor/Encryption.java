...
public class Encryption {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            logger.log(Level.ALL,"Error occurred while encrypting or while writing in to the file ");
            ex.printStackTrace();
            return;
        }
        Arrays.fill(passwordArray, (char) 0);
        logger.log(Level.INFO,"File with encrypted value created successfully in your current location");
    }
}
